//A resource from https://forum.unity.com/threads/cylindrical-billboard-shader-shader-for-billboard-with-rotation-restricted-to-the-y-axis.498406/
...
Shader "Custom/Billboard Y Rotation Only"
{
    ...
    {  
        ...
        Pass
        {
            ...
            {
                return tex2D(_MainTex, float2(input.tex.x, input.tex.y));  
            }
            ENDCG
        }
    }
